...
np.savetxt('fig-height-vs-radius-fz1-fr0-sigp5-cp1.dat', combined_data, comments='')
#############
#sys.exit()
...
np.savetxt('vertices-fz1-fr0-sigp5-cp1.dat', best_vertices, comments='')
np.savetxt('triangles-fz1-fr0-sigp5-cp1.dat', triangles_array, comments='')
...
ax.set_zlim(0, 10)
ax.set_axis_off()
plt.savefig('fig-3d-tri-fz1-fr0-sigp5-cp1.pdf', format='pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('fig-energy-fz1-fr0-sigp5-cp1.pdf', format='pdf', bbox_inches='tight')
plt.show()
